...
public class DingoAggregateVisitFun {
    ...
    static class OperatorSupplier implements Supplier<Vertex> {
        ...
        @Override
        public Vertex get() {
            // Use the aggregate output row type as schema for spilling AggCache entries.
            // Format: [group_key_cols, agg_state_values] — matches AggCache.reduce() input.
            DingoType schema = DefinitionMapper.mapToDingoType(rel.getRowType());
